...
public class SiteManagerRegisterDonationActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_site_manager_register_donation);
        ...
        findButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mMap.clear();
                Toast.makeText(SiteManagerRegisterDonationActivity.this, "Finding blood donation within 5km...", Toast.LENGTH_SHORT).show();
                            ...
                            if (task.isSuccessful() && task.getResult() != null) {
                                for (DocumentSnapshot document : task.getResult().getDocuments()) {
                                    ...
                                    if (results[0] <= 5000) {
                                        ...
                                        if(mMap != null) {
                                            mMap.setInfoWindowAdapter(new CustomInfoWindowAdapter(SiteManagerRegisterDonationActivity.this));
                                        }
                                    }
                                }
                            } else {
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                            .findFragmentById(R.id.map);
                    mapFragment.getMapAsync(SiteManagerRegisterDonationActivity.this);
                }
            }
        });
    }
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        mMap.setOnInfoWindowClickListener(marker -> {
            if (marker.getTag() instanceof CustomInfoMarkerClass) {
                ...
                Intent intent = new Intent(SiteManagerRegisterDonationActivity.this, DonorSiteDetailActivity.class);
